...
export const DepartmentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="reactServiceApp.department.delete.question">
        <Translate contentKey="reactServiceApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
